...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="header_img"> <img src="{{ Storage::url(auth()->user()->avatar) }}" alt=""> </div>
    </header>
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="{{ route('home') }}" class="nav_logo"> <img src="{{ asset('assets/logo.png') }}"
                        width="25" alt=""> <span class="nav_logo-name">Sohojware</span> </a>
                <div class="nav_list">
                    <a href="#" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i> <span
                            class="nav_name">Dashboard</span> </a>
                    <a href="#" class="nav_link"> <i class='bx bx-briefcase nav_icon'></i> <span
                            class="nav_name">Projects</span> </a>
            ...
            <form action="{{ route('logout') }}" method="POST">
                ...
                <button type="submit" class="nav_link"
                    style="background: none; border: none; color:var(--white-color) ; font: inherit; cursor: pointer;">
