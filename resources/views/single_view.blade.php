                    ...
                    <div class="col-12  col-lg-3 mx-auto ">
                        <div class="profile ">
                            ...
                            <div class="tm-details">
                                <h6 class="name">{{ $member->name }}</h6><span
                                    class="role">{{ $member->designation }}<span
                                ...
                                <div class="sc-wrapper dir-row sc-size-40">
                                    <ul class="sc-list">
                                        <li class="sc-item " title="Facebook"><a class="sc-link"
                                                href="{{ $member->facebook }}" title="social media icon"><i
                                                    class="fab fa-facebook-f sc-icon"></i></a></li>
                                        <li class="sc-item " title="Linkedin"><a class="sc-link"
                                                href="{{ $member->linkedin }}" title="social media icon"><i
                                        ...
                                        <li class="sc-item " title="twitter"><a class="sc-link"
                                                href="{{ $member->github }}" title="social media icon"><i
                                                    class="fab fa-github sc-icon"></i></a></li>
                                    </ul>
                                </div>
                            </div>
