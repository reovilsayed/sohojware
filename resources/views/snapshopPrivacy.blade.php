...
@section('content')
    ...
    <div class="container">
        ...
        <p>This Privacy Policy ("Policy") applies to SnapShop, an ecommerce application available for download on the Google
            ...
            committed to safeguarding the privacy of our users, and this Policy outlines how we collect, use, and protect
            your
        ...
        <ul>
            <li>The types of personal and sensitive data we collect, such as name, contact information, transaction details,
                and
                device identifiers.</li>
            <li>How we use this data, which includes managing user accounts, processing orders, personalizing user
                experiences,
                and improving our services.</li>
            <li>Parties with whom we may share user data, such as third-party service providers assisting with app
                functionality
                or legal authorities as required by law.</li>
            <li>Our procedures for securely handling and protecting user data, including encryption, access controls, and
                data
        ...
        <p>SnapShop reserves the right to update or modify this Policy as needed. Any changes will be prominently displayed
            within the app and on the Google Play Store listing. Your continued use of SnapShop following any changes to
            this
