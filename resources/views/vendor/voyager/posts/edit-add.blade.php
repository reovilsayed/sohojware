                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status">
                                    ...
                                    <option value="SCHEDULE"@if (isset($dataTypeContent->status) && $dataTypeContent->status == 'SCHEDULE') selected="selected" @endif>
                                        Schedule</option>
                                </select>
                            </div>
                            <div class="form-group published_date_section">
                                <label for="publish_date">Publish Date</label>
                                <input type="date" class="form-control" id="publish_date" name="publish_date"
                                    placeholder="publish_date" value="{{ $dataTypeContent->publish_date ?? '' }}">
                            </div>
                            <div class="form-group">
