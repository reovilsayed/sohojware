...
$(function () {
    ...
    function fireCounter() {
        if ($(".js-stats-counter").length) {
            if (jQuery().countTo && counterShowsUp === false) {
                ...
                if (
                    main_window.scrollTop() + main_window.innerHeight() - 50 >=
                    pos
                ) {
                    $(".counter").countTo();
                    counterShowsUp = true;
    ...
    function setThemeMode(themeColor) {
        if (themeColor === darkTheme_class) {
            ...
            modeSwitcher
                .addClass(darkTheme_class)
                .removeClass(lightTheme_class);
        ...
        if (themeColor === lightTheme_class) {
            ...
            modeSwitcher
                .addClass(lightTheme_class)
                .removeClass(darkTheme_class);
   ...
   ---------------------------------- */
    ...
    /* *******  start open/close navbar search box   ********/
    $(".header-search-box .close-search , .header-search-box").on(
        "click",
        () => {
    ...
    $(".landing-page-demo .menu-navbar .menu-link").on("click", function (e) {
        ...
        if (link.charAt(0) === "#") {
            ...
            $(root).animate(
                {
                    scrollTop:
                        $(target).offset().top - currentMainNavHeight + 1,
                },
                500
            );
